...
def ChelseaPD_Pensions(PD_fraction):
    ...
    pension_costs.loc["Chelsea Pension Contribution Expenditure", 2019] = 7691415.83
...
def ReverePD_Pensions(reverePD_payroll):
    ...
    final_total_payroll[2019] = final_total_payroll[2018]

    reverePD_fraction = reverePD_payroll[list(range(2016, 2020))]/final_total_payroll



    pension_final = pension_contributions.loc["Pension Recap Estimated", [2016, 2017]]
    pension_final[2018] = pension_contributions.loc["Pension Appropriation", 2018]
    pension_final[2019] = pension_contributions.loc["Pension Appropriation", 2019]
