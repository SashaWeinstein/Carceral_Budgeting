...
def trial_court_correction(df):
    ...
    trial_court_suffolk_correction = trial_court_suffolk()
...
def get_trial_court_dict():
    trial_court_correction = {2016: 30756 / 209791, 2017: 28264 / 197900,
                              2018: 27818 / 190661, 2019: 26576 / 187817}
    return trial_court_correction

def get_trial_court_series():
    trial_court_suffolk_correction = pd.Series(index=list(range(2016, 2021)),
                                               data=[30756/209791,
                                                     28264/197900,
                                                     27818/190661,
                                                     26576/187817,
...
def trial_court_suffolk():
    ...
    return df.sum() / total_criminal_cases
